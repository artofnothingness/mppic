...
template <typename... Components> void activate(Components &&...cmps) {
  (cmps.on_activate(), ...);
}

template <typename... Components> void cleanup(Components &&...cmps) {
  (cmps.on_cleanup(), ...);
}

template <typename... Components> void deactivate(Components &&...cmps) {
  (cmps.on_deactivate(), ...);
}
