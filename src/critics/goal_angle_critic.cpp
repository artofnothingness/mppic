...
void GoalAngleCritic::initialize()
{
  ...
  getParam(power_, "goal_angle_cost_power", 1, ParameterType::Dynamic);
  getParam(weight_, "goal_angle_cost_weight", 5.0, ParameterType::Dynamic);
  getParam(
    threshold_to_consider_goal_angle_,
    "threshold_to_consider_goal_angle", 0.20, ParameterType::Dynamic);
  RCLCPP_INFO(
    logger_,
