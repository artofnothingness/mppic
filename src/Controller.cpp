...
template <typename T, typename Model> void Controller<T, Model>::cleanup() {
...
template <typename T, typename Model> void Controller<T, Model>::activate() {
...
template <typename T, typename Model> void Controller<T, Model>::deactivate() {
...
template <typename T, typename Model>
geometry_msgs::msg::TwistStamped Controller<T, Model>::computeVelocityCommands(
...
void Controller<T, Model>::configureComponents() {
  ...
  trajectory_visualizer_.on_configure(parent_,
