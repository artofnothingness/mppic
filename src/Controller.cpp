...
template <typename T> void Controller<T>::cleanup() {
...
template <typename T> void Controller<T>::activate() {
...
template <typename T> void Controller<T>::deactivate() {
...
template <typename T> void Controller<T>::getParams() {
