...
template <typename T>
void
Controller<T>::configure(const std::shared_ptr<rclcpp_lifecycle::LifecycleNode> &parent,
...
template <typename T>
void
Controller<T>::handleVisualizations(const geometry_msgs::msg::PoseStamped &robot_pose,
                                    const geometry_msgs::msg::Twist &robot_speed,
